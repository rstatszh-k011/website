...
- Team-Data im Statistischen Amt 
- Verantwortlicher R-Infrastruktur
- Debug-Master
...
Um auf den vollen Genuss der R-Analyse Umgebung zu kommen, musst du im Serviceportal folgende Module bestellen:
...
Im Kanton haben wir eine Community of Practice für R, welche im Teams angesiedelt ist.

Der Kanal soll folgende Zwecke erfüllen:

- Austausch zwischen allen R-Nutzenden im Kanton
- Information über das R-Bundle
- ...
...
- Weiterentwicklung der Installation
- Bedürfnisabklärung
- Support bei Instalationsproblemen
- ...
...
```{=html}
<iframe src="https://rstatszh-k009.github.io/website/module/md-02.html" width="100%" height="500" style="border:2px solid #123233;" title="Module 2 documentation"></iframe>
```
:::
