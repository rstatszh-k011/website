...
```         
![Pinguine spielen mit einem Quarto-Ball](images/penguins-quarto-ball.png)
```
...
![Blauer Pinguin](images/blue-penguin.png){#fig-blue width="250px"}

![Orangefarbener Pinguin](images/orange-penguin.png){#fig-orange width="250px"}
...
![Orangefarbener Pinguin](images/orange-penguin.png){#fig-sleep width="250px"}
...
-   Querverweise Schritte:
    ...
    -   Füge deiner Abbildung oder Tabelle eine Beschriftung hinzu.
    -   Gib deiner Figur oder Tabelle eine ID, beginnend mit `fig-` oder `tbl-`.
    -   Verweise darauf mit `@fig-...` oder `@tbl-...`.
...
![Blauer Pinguin](images/blue-penguin.png){#fig-blue-penguin}
```
:::
...
![Blauer Pinguin](images/blue-penguin.png){#fig-blue-penguin fig-alt="Ein blauer Pinguin" width="150"}
:::
:::
