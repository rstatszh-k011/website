...
grading <- read_csv(here::here("data/tbl-02-rstatszh-k009-abschlussprojekt.csv"))
...
lobj <- readr::read_csv(here::here("data/tbl-01-rstatszh-k009-lernziele.csv")) |> 
...
- [Module 5 - Übungsaufgabe 2](../zusatzaufgaben/md-05/za-05-02-abschlussprojekt.qmd): Abschlussprojekt - Daten auswählen
...
1.  Öffne github.com in deinem Browser und navigiere zur GitHub-Organisation für den Kurs: <https://github.com/rstatszh-k009>.
